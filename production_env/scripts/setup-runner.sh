...
echo "Register gitlab-runner for release"
sudo gitlab-runner register --url "http://192.168.33.9/gitlab/" --registration-token ${gitlab_runner_token} --executor shell --description "shell" --tag-list "production-vm-engineering-shell" --run-untagged="true" --non-interactive
